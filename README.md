...
7. The **segmentaion maps** produced at this low resolution (128x128) produce coarse or **sharp edges** (stair-case effect), especially when we resize them to higher resolution.
